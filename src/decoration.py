import pygame
from settings import vertical_tile_number, tile_size, screen_width, decoration_settings
...
class Sky:
    def __init__(self, horizon, style='level'):
        ...
        if self.style == 'overworld':
            palm_surfaces = import_images_from_folder('./graphics/overworld/palms')
            self.palms = []
            ...
            cloud_surfaces = import_images_from_folder('./graphics/overworld/clouds')
            self.clouds = []
...
class Water:
    def __init__(self, top, level_width):
        ...
        water_tile_width = decoration_settings['water_tile_width']
...
class Clouds:
    def __init__(self, horizon, level_width, cloud_number):
        cloud_surf_list = import_images_from_folder('./graphics/decoration/clouds')
        min_x = -screen_width
